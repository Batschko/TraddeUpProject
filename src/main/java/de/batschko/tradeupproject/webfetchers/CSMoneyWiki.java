...
public class CSMoneyWiki {
    ...
    public static Map<String, Map<String, List<Double>>> fetchBotItems(byte custom, List<Integer> tupIds){
        ...
        HashMap<String, Map<String, Map<String, Double>>> urlSkinMap = getCSMoneyUrls(custom ,tupIds);
        boolean fetchedAll;
        int offsetVal;
        //  url      skinName    floats
    ...
    private static HashMap<String, Map<String, Map<String, Double>>> getCSMoneyUrls(byte custom, List<Integer> tupIds) {
        ...
        for (int id : tupIds) {
            Result<Record6<String, String, String, Rarity, Byte, Condition>> tupSkinInfo = QRCS2Skin.getTradeUpSkinInfo(custom, id);
    ...
    private static String createCSMoneyUrl(String collName, String rarityVal, boolean stattrak, Map<String, Double> condMap){
        ...
        int defaultOffset = 0;
        //if it gets more map to replace
