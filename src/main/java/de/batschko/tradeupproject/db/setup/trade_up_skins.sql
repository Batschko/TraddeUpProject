...
CREATE TABLE IF NOT EXISTS `trade_up_skins` (
  ...
  KEY `FK_trade_up_skins_trade_up` (`custom`,`trade_up_id`),
  CONSTRAINT `FK__c_s2_skin` FOREIGN KEY (`c_s2_skin_id`) REFERENCES `c_s2_skin` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_trade_up_skins_trade_up` FOREIGN KEY (`custom`, `trade_up_id`) REFERENCES `trade_up` (`custom`, `id`) ON DELETE NO ACTION ON UPDATE NO ACTION
